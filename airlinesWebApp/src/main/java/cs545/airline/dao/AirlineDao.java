...
//  Couldn't figure out another way to inject the persistence context
	...
	public void delete(Airline airline) {
		System.out.println("+++++++++++++++++++++++entro a eliminar en el DAO");
		EntityTransaction transaction = entityManager.getTransaction();
		System.out.println("DATOS: "+ airline );
		transaction.begin();
	...
	public Airline findOneById(long id) {
		Query query = entityManager.createQuery("select a from Airline a where a.id=:id", Airline.class);
